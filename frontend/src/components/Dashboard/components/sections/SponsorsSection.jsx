...
const SponsorsSection = () => {
 const {
  ...
  const handleDeleteSponsor = () => {
    setSponsors((prev) =>
      prev.filter((sponsor) => sponsor.id !== selectedSponsor.id)
    );
  ...
  return (
    <div className="p-6">
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleEditSponsor} className="space-y-4">
              <ImageInput
                ...
                existingImage={selectedSponsor?.image}
              />
              <div>
                <label className="block text-sm font-medium mb-1">
                  Sponsor Title
      ...
      {isDeleteOpen && selectedSponsor && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">Delete Sponsor</h2>
              <button onClick={() => setIsDeleteOpen(false)} className="p-1">
                <X className="w-6 h-6" />
              </button>
            </div>
